...
- To help minimize the effect of DoS and DDoS attacks on your applications, you can use [25B-AWS Shield](AWS/Cloud Practitioner (CLF-C02)/06-Security/25B-AWS Shield.md)

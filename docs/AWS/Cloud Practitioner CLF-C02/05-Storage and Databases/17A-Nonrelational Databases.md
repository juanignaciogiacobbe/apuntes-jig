...
- [[AWS/Cloud Practitioner CLF-C02/05-Storage and Databases/17B-Amazon DynamoDB]] provides a NoSQL Database service.

	![[AWS/Cloud Practitioner CLF-C02/img/nonrelational_db.png]]
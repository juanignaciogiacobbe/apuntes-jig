...
- It has complete access to all the AWS services and resources in the account.
	...
	![[AWS/Cloud Practitioner CLF-C02/img/aws_account_root_user.png]]
...
- By default, when you create a new IAM user in AWS, it has no permissions associated with it. To allow the IAM user to perform specific actions in AWS, such as launching an [[AWS/Cloud Practitioner CLF-C02/02-Compute in the Cloud/01-Amazon Elastic Compute Cloud EC2]] instance or creating an [[AWS/Cloud Practitioner CLF-C02/05-Storage and Databases/01-Amazon Simple Storage Service S3]] bucket, you must grant the IAM user the necessary permissions.
...
- **When you assign an IAM policy to a group, all users in the group are granted permissions specified by the policy**.
	...
	![[AWS/Cloud Practitioner CLF-C02/img/iam_groups.png]]
...
- In IAM, **multi-factor authentication (MFA) provides an extra layer of security for your AWS account**.
	...
	![[AWS/Cloud Practitioner CLF-C02/img/multi-factor-auth1.png]]

	![[AWS/Cloud Practitioner CLF-C02/img/multi-factor-auth2.png]]
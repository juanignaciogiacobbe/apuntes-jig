...
- Consider employing the [[AWS/Cloud Practitioner CLF-C02/09-Migration and Innovation/37-AWS Cloud Adoption Framework]] and [[AWS/Cloud Practitioner CLF-C02/10-The Cloud Journey/41-The AWS Well-Architected Framework]] to plan and execute your digital transformation at scale.

	![[AWS/Cloud Practitioner CLF-C02/img/shared_responsibility_model.png]]

...
- By default, when you create a new IAM user in AWS, it has no permissions associated with it. To allow the IAM user to perform specific actions in AWS, such as launching an [[01-Amazon Elastic Compute Cloud EC2]] instance or creating an [[01-Amazon Simple Storage Service S3]] bucket, you must grant the IAM user the necessary permissions.

...
> - Data is automatically replicated synchronously to 3 [[AWS/Cloud Practitioner (CLF-C02|AZ]]/03-Infrastructure%20and%20Realiability/02-Availability%20Zones.md).
...
> - Data Ingestion into Redshift/ [[AWS/Cloud Practitioner (CLF-C02|Amazon S3]]/05-Storage%20and%20Databases/01-Amazon%20Simple%20Storage%20Service(S3).md), ElasticSearch / Splunk.
> - Automatic scaling.
> - Supports many data formats.
> - Data Conversions from CSV/ JSON to Parquet / ORC(only for S3).
> - Data Transformation through [[AWS/Cloud Practitioner (CLF-C02|AWS Lambda]]/02-Compute%20in%20the%20Cloud/06-AWS%20Lambda.md).
